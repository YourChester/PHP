...
<body>
	<div class="d-flex justify-content-between">
		...
		<div class="row justify-content-center ">
			...
			<div class="col-2">
					<p><a href="<?php if($sort == 1) echo "http://my-site.loc/sortByName/2";
									if($sort == 2) echo "http://my-site.loc/sortByName/1"; ?>">Автор</a></p>
			</div>
			<div class="col-3">
				<p><a href="<?php if($sort == 1) echo "http://my-site.loc/sortByEmail/2";
									if($sort == 2) echo "http://my-site.loc/sortByEmail/1"; ?>">Email автора</a></p>
			</div>
			<div class="col-1">
				<p><a href="<?php if($sort == 1) echo "http://my-site.loc/sortByComplete/2";
									if($sort == 2) echo "http://my-site.loc/sortByComplete/1"; ?>">Готовность</a></p>
			</div>
		</div>
		<hr>
		<div class="row justify-content-center ">
